...
class FormatDialog(wx.Dialog):
    ...
    def __init__(self, parent, formatData, tabToShow=0):
        ...
        wx.Dialog.__init__(self, parent, -1,  _('Format'), style=wx.CAPTION | wx.SYSTEM_MENU)
        ...
        boxButtons.Add((1, 1), 1)

        # Create an OK button
        btnOK = wx.Button(self, wx.ID_OK, _("OK"))
        btnOK.SetDefault()
        btnOK.Bind(wx.EVT_BUTTON, self.OnOK)
        boxButtons.Add(btnOK, 0, wx.RIGHT, 20)

        # Create a Cancel button
        btnCancel = wx.Button(self, wx.ID_CANCEL, _("Cancel"))
        btnCancel.Bind(wx.EVT_BUTTON, self.OnCancel)
        boxButtons.Add(btnCancel, 0)

        # Add the boxButtons sizer to the main box sizer
        box.Add(boxButtons, 0, wx.EXPAND | wx.ALL, 10)
        ...
        wx.CallLater(50, self.panelFont.SetSampleFont)
