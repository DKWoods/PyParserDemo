...
class FormatFontPanel(wx.Panel):
    ...
    def __init__(self, parent, fontData, sampleText='AaBbCc ... XxYyZz'):
        ...
        boxFont.Add(self.lbFont, 3, wx.ALIGN_LEFT | wx.EXPAND | wx.GROW)
        ...
        boxSize.Add(self.lbSize, 3, wx.ALIGN_LEFT | wx.EXPAND | wx.GROW)
        boxTop.Add((15, 0))  # Spacer

        # Add the boxSize sizer to the boxTop sizer
        boxTop.Add(boxSize, 3, wx.EXPAND | wx.GROW)
        ...
        boxStyle.Add(self.cbColor, 1, wx.ALIGN_LEFT)
        ...
        boxStyle.Add(self.cbBgColor, 1, wx.ALIGN_LEFT)
        ...
        boxSample.Add(self.txtSample, 1, wx.EXPAND | wx.GROW) 

        # Add the boxSample sizer to the boxMiddle sizer
        boxMiddle.Add(boxSample, 3, wx.EXPAND | wx.GROW)
    ...
    def SetSampleFont(self):
        ...
        try:
            ...
            bmp = wx.Bitmap(bmpWidth, bmpHeight)
